      ...
      <div ref={this.rootRef} className={styles.container}>
        {normalizeEvents(events).map(event => {
          ...
          return (
            ...
            >
              <img className={styles.hostAvatar} src={event_hostheadurl} />
              <div className={styles.content} style={{ background: category_color }}>
                <div className={styles.eventTime}>{`${event_time} - ${event_endtime}`}</div>
