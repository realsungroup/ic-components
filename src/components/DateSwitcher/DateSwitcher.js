  ...
  render() {
    ...
    return (
      <div className={classnames(styles.container, className)}>
        <img className={styles.arrow} src={leftArrow} onClick={this.switchBack} />
        <div className={styles.text} onClick={this.switchToNow}>今天</div>
        <img className={styles.arrow} src={rightArrow} onClick={this.switchForward} />
      </div>
    );
  }
}
